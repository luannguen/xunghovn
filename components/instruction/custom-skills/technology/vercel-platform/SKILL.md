...
description: Version-aware Vercel Platform production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing Vercel configuration, deployment workflows, environment variables, functions, routing, or project settings.
---

---
name: tanstack-query
description: Version-aware TanStack Query production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing TanStack Query clients, query keys, hooks, mutations, invalidation, hydration, retries, or cache configuration.
---

...
description: Version-aware Base44 Platform production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing Base44 SDK, entity definitions, functions, connectors, auth configuration, GitHub sync, generated application code, or deployment behavior.
---

# Base44 Platform Router

---
name: nextjs
description: Version-aware Next.js production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing App Router or Pages Router routes, layouts, server actions, caching, middleware, or Next.js configuration.
---

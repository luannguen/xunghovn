...
description: Version-aware React Hook Form Zod production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing React Hook Form controllers, registrations, resolvers, Zod schemas, field arrays, or submission behavior.
---

# React Hook Form Zod Router

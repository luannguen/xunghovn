---
name: pwa-webview
description: Version-aware PWA WebView production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing web app manifests, service workers, offline caching, install prompts, update flows, deep links, WebView bridges, or embedded-browser behavior.
---

...
description: Version-aware Postgres Supabase DB production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing PostgreSQL schemas, migrations, SQL functions, RLS policies, indexes, constraints, or Supabase database behavior.
---

# Postgres Supabase DB Router

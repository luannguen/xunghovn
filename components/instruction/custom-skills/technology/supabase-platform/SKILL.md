...
description: Version-aware Supabase Platform production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing Supabase Auth, Storage, Realtime, Edge Functions, client setup, RLS-facing access, CLI configuration, or platform integrations.
---

# Supabase Platform Router

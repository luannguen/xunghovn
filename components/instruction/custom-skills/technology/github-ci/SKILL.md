---
name: github-ci
description: Version-aware GitHub CI production guidance. Use only when project detection and an active binding prove this technology is in the task scope; trigger on editing GitHub Actions workflows, repository automation, CODEOWNERS, Dependabot, release workflows, permissions, or CI policy.
---

...
description: Evidence-gated RBAC Scoped Access domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches roles, permissions, scoped resources, policy evaluation, grants, delegation, or revocation; never infer business invariants from names.
---

# RBAC Scoped Access Router

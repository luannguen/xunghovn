...
description: Evidence-gated AI Agent Domain domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches agent runs, plans, tools, approvals, delegation, memory, policy decisions, autonomy, or human review; never infer business invariants from names.
---

# AI Agent Domain Router

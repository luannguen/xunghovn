---
name: gift-lifecycle
description: Evidence-gated Gift Lifecycle domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches gifts, senders, recipients, delivery, claim, redemption, expiry, cancellation, or transfer; never infer business invariants from names.
---

# Gift Lifecycle Router

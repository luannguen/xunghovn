...
description: Evidence-gated Notification Messaging domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches notifications, email, SMS, push, inbox messages, templates, preferences, consent, retries, or delivery status; never infer business invariants from names.
---

# Notification Messaging Router

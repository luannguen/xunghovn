...
description: Evidence-gated Referral Commission domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches referrals, attribution, affiliate relationships, commissions, eligibility, approval, reversal, or payout; never infer business invariants from names.
---

# Referral Commission Router

---
name: ecard-connection
description: Evidence-gated Ecard Connection domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches ecards, profile cards, sharing, connection requests, acceptance, revocation, contact synchronization, or privacy; never infer business invariants from names.
---

# Ecard Connection Router

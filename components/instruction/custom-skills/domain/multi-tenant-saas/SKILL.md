...
description: Evidence-gated Multi Tenant SaaS domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches tenant ownership, organization/workspace membership, tenant-scoped data, or cross-tenant administration; never infer business invariants from names.
---

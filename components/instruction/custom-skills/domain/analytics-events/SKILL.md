...
description: Evidence-gated Analytics Events domain guardrails. Use when authoritative project source, schema, tests, contracts, or specifications verify this domain and the active task touches analytics events, tracking plans, identity, attribution, funnels, telemetry payloads, consent, or event schemas; never infer business invariants from names.
---
